...
createApp({
  setup: function() {
    ...
    function submitQuiz() {
      ...
      var record = {
        ...
        chapter: selectedChapters.value.join(','),
        wrongIds: wrongArr
      };
    ...
    return {
      ...
      history: history, currentQuestion: currentQuestion,
      progressPercent: progressPercent, resultStats: resultStats,
      ...
      goSetup: goSetup, toggleChapter: toggleChapter,
  ...
  <div>\
    ...
    <div v-if="page === \'quiz\' && !showResult">\
      ...
      <div v-if="currentQuestion" class="card">\
        <div class="q-meta">\
          ...
          <span class="q-num">{{ currentQuestion.chapter }}</span>\
    ...
    <div v-if="page === \'result\' && resultStats">\
      ...
      \
      <div class="flex-row mt-12" style="gap:12px">\
        <button class="btn btn-outline" style="flex:1" @click="goSetup">返回首页</button>\
        <button class="btn btn-primary" style="flex:1" @click="startQuiz">再来一卷</button>\
      </div>\
      \
